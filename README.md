...
**NOTE:** If you are using the Git Bash terminal or any other Linux terminal emulator on Windows, you _must_ use `strongback.exe` rather than `strongback` everytime your run the Strongback CLI.
